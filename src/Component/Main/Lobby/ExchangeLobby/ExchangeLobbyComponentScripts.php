 ...
 *
 */
class ExchangeLobbyComponentScripts implements ComponentAttachmentInterface
{
    private $configs;
    ...
    {
        try {
            $exchangeGeneralConfig = $this->configs->getConfig('exchange.exchange_configuration');
        } catch (\Exception $e) {
            $exchangeGeneralConfig = [];
        }
