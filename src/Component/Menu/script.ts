...
export class MenuComponent implements ComponentInterface {
    ...
    private updateMenuRouter() {
        ComponentManager.subscribe("menu.update.router.component", (event, src, data) => {
            ...
            home.setAttribute("data-router-refresh", `["main", "language", "${data.val}"]`);
            promotion.setAttribute("data-router-refresh", `["main", "language", "${data.val}"]`);
            if (this.isLogin) {
                ...
                password.setAttribute("data-router-refresh", `["main", "language", "${data.val}"]`);
                account.setAttribute("data-router-refresh", `["main", "language", "${data.val}"]`);
            }
        });
    }
    ...
    private updateLogoRouter() {
        ComponentManager.subscribe("menu.update.logo.component", (event, src, data) => {
            ...
            logo.setAttribute("data-router-refresh", `["main", "language", "${data.val}"]`);
        });
    }
