...
export class ExchangeLauncherModule implements ModuleInterface, GameInterface {
    private key: string = "exchange_launcher";
    private moduleName: string = "exchange_launcher_integration";
